...
- **Relates to:** [[Terraform/2. State Management|2. State Management]] — every resource block creates a state entry
- **Relates to:** [[Terraform/3. Modules|3. Modules]] — modules are built from these same blocks
