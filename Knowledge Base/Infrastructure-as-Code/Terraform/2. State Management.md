...
- **Relates to:** [[Terraform/1. HCL Fundamentals|1. HCL Fundamentals]] — every resource block you write creates a state entry
- **Relates to:** [[Terraform/3. Modules|3. Modules]] — each module root can have its own remote state
