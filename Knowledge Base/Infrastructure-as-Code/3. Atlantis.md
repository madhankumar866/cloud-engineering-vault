...
- **Relates to:** [[Terraform/6. Testing & Validation|6. Testing & Validation]] — custom Atlantis workflows run `tflint` and `checkov` before `plan`
- **Relates to:** [[2. Terragrunt]] — Terragrunt workflows can be configured inside `atlantis.yaml`
- **Relates to:** [[Terraform/2. State Management|2. State Management]] — Atlantis manages state locking across concurrent PRs
