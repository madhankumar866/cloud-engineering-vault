...
- [[VPC/VPC-Peering|VPC Peering]] — direct, non-transitive routing between two VPCs; no overlapping CIDRs.
- [[VPC/VPN-connections|VPN Connections]] — Site-to-Site, Client VPN, and CloudHub for secure hybrid cloud connectivity.
- [[VPC/VPC Flow Logs|VPC Flow Logs]] — capture, store, and query IP traffic metadata for visibility and debugging.
- [[VPC/VPC-Terraform-Labs|VPC Terraform Labs]] — hands-on exercises to build all VPC components using Terraform (beginner → capstone).

## 🔗 Connections (Zettelkasten)
- **Relates to:** [[6. EKS Architecture|EKS Architecture]]
- **Relates to:** [[Terraform]] — practice building VPC resources with Terraform in [[VPC/VPC-Terraform-Labs|VPC Terraform Labs]]
